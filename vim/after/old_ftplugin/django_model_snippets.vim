...
exec "Snippet mmodel class ".st.et."(models.Model):<CR>\"\"\" ".st.et." \"\"\"<CR>".st.et." = ".st.et."<CR><CR>class Meta:<CR>pass<CR><CR>def __unicode__(self):<CR>return u\"".st."s".et."\" % ".st."s:DjangoArgList(Count(@z, '%[^%]'))".et."<CR><CR>@models.permalink<CR>def get_absolute_url(self):<CR>return (".st.et.")<CR><CR>".st.et
